import { filterInternalGames, exportInternalGames, TOTAL_RESULTS } from '../analytics/internalGames.js?v=5.6.0';
...
export function createInternalGamesPanel(getState) {
    ...
    el('run').addEventListener('click',() => {
        ...
        try {
            worker = new Worker(new URL('../workers/internalGames.worker.js?v=5.6.0',import.meta.url),{type:'module'});
            const active = worker;
