import { TOTAL_RESULTS } from '../analytics/portfolio.js?v=5.4.0';
import { exportInternalGames } from '../analytics/internalGames.js?v=5.4.0';
export function createPortfolioPanel(getSaved) {
    ...
    el('run').onclick=async()=>{
        ...
        try {
            ...
            worker=new Worker(new URL('../workers/portfolio.worker.js?v=5.4.0',import.meta.url),{type:'module'});
